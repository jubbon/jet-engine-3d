...
Известно отставшее (на момент написания файла): `docs/01-architecture.md` и
`docs/08-development.md` обещают ~850 тыс. треугольников, ~50 вызовов отрисовки и
«около 1500 лопаток», тогда как фактически 758 тыс., 123 и 2351; таблица строк по
файлам в `01` тоже отстаёт на несколько десятков строк.
