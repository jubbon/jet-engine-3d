...
npm test         # проверка автомата состояний двигателя (запуск/останов/выбег)
```
...
| Вентилятор (N1) | 22 широкохордные лопатки со стреловидностью, кок со спиралью, диск |
...
test/             проверки автомата состояний (npm test)
```
