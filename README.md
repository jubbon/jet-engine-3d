...
npm test         # проверки автомата состояний, выхлопных газов и смаза спирали
```
...
| Вентилятор (N1) | 24 широкохордные лопатки со стреловидностью, кок со спиралью (смазывается с оборотами), диск |
