...
1 условная единица ≈ **0.55 м**: вентилятор диаметром 3.12 у.е. соответствует
1.7 м — это класс CFM56-5B. Полная длина модели от кромки воздухозаборника до
конца центрального тела — 9.95 у.е. ≈ 5.5 м.
...
| Вентилятор | 22 широкохордные лопатки со стреловидностью и наклоном, кок с белой спиралью, диск |
...
У реальных двигателей этого класса вентилятор имеет 18 (LEAP-1A) или 36
(CFM56-5B) лопаток; 22 — промежуточное значение, выбранное ради узнаваемого
силуэта широкохордного вентилятора.
