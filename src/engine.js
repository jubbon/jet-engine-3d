 ...
 *  1 условная единица ≈ 0.55 м (вентилятор Ø ~3.1 у.е. ≈ 1.7 м).
 * ------------------------------------------------------------------ */
...
export function buildEngine() {
  ...
  const mFan = module(
    'fan',
    'Вентилятор (N1)',
    '22 широкохордные лопатки из композита с титановой кромкой. Диаметр ~1.7 м. Создаёт до 80 % тяги, прогоняя воздух в наружный контур. Степень двухконтурности ≈ 9:1.',
  ...
  fanRot.add(bladeRow(fanBlade, MATS.composite, 22));
